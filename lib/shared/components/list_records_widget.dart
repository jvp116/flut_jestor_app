...
class ListRecordsWidget extends StatefulWidget {
  final FinancialRecordController controller;

  const ListRecordsWidget({Key? key, required this.controller}) : super(key: key);

  @override
  State<ListRecordsWidget> createState() => _ListRecordsWidgetState();
}

class _ListRecordsWidgetState extends State<ListRecordsWidget> {
  @override
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child:
                                  Text(financialRecord.description, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: blue)),
                            ),
                          ),
                          Padding(
                                                      ...
                                                      child: Form(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            const Text("categoria",
                                                                style: TextStyle(
                                                                    color: Color.fromRGBO(0, 0, 0, 0.5), fontWeight: FontWeight.w500, fontSize: 12)),
                                                            TextFormField(
                                                                controller:
